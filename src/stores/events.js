...
const mockEvents = [
  ...
  { id: 3, title: 'Reading Program for Kids', category: 'Education', date: 'Sep 25', time: '14:00', location: 'Central Library', description: 'Volunteer to read stories and help children develop their reading skills.', organizerId: 1, volunteers: [], maxVolunteers: 20, icon: '📚' },
  { id: 4, title: 'Animal Shelter Support', category: 'Animals', date: 'Oct 5', time: '11:00', location: 'City Animal Shelter', description: 'Help care for animals and assist with shelter operations.', organizerId: 1, volunteers: [], maxVolunteers: 15, icon: '🐾' },
  { id: 5, title: 'Tree Planting Initiative', category: 'Environment', date: 'Oct 12', time: '08:00', location: 'City Park', description: 'Join our tree planting campaign to create a greener community.', organizerId: 1, volunteers: [], maxVolunteers: 40, icon: '🌳' }
]
...
export const useEventsStore = defineStore('events', {
  ...
  actions: {
    createEvent(eventData) {
      const newEvent = { ...eventData, id: Date.now(), volunteers: [], icon: eventData.icon || '📅' }
